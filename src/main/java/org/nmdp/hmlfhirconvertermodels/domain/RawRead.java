...
public class RawRead extends SwaggerConverter<RawRead, org.nmdp.hmlfhirconvertermodels.dto.RawRead> implements Serializable, ICascadable {

    private static Class<RawRead> tClass = RawRead.class;
    private static Class<org.nmdp.hmlfhirconvertermodels.dto.RawRead> uClass = org.nmdp.hmlfhirconvertermodels.dto.RawRead.class;
