...
public class SbtNgs extends SwaggerConverter<SbtNgs, org.nmdp.hmlfhirconvertermodels.dto.SbtNgs> implements Serializable, ICascadable {

    private static Class<SbtNgs> tClass = SbtNgs.class;
    private static Class<org.nmdp.hmlfhirconvertermodels.dto.SbtNgs> uClass = org.nmdp.hmlfhirconvertermodels.dto.SbtNgs.class;
