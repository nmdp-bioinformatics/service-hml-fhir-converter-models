...
public class Hml extends SwaggerConverter<Hml, org.nmdp.hmlfhirconvertermodels.dto.Hml> implements Serializable, ICascadable {

    private static Class<Hml> tClass = Hml.class;
    private static Class<org.nmdp.hmlfhirconvertermodels.dto.Hml> uClass = org.nmdp.hmlfhirconvertermodels.dto.Hml.class;
    ...
    public Hml(Boolean active) {
        super(Hml.class, org.nmdp.hmlfhirconvertermodels.dto.Hml.class);
        this.active = active;
