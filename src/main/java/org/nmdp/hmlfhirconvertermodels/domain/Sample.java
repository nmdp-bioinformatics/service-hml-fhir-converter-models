...
public class Sample extends SwaggerConverter<Sample, org.nmdp.hmlfhirconvertermodels.dto.Sample> implements Serializable, ICascadable {

    private static Class<Sample> tClass = Sample.class;
    private static Class<org.nmdp.hmlfhirconvertermodels.dto.Sample> uClass = org.nmdp.hmlfhirconvertermodels.dto.Sample.class;
    ...
    public Sample(Boolean active) {
        super(Sample.class, org.nmdp.hmlfhirconvertermodels.dto.Sample.class);
        this.active = active;
