...
public class Sequence extends SwaggerConverter<Sequence, org.nmdp.hmlfhirconvertermodels.dto.Sequence> implements Serializable, ICascadable {

    private static Class<Sequence> tClass = Sequence.class;
    private static Class<org.nmdp.hmlfhirconvertermodels.dto.Sequence> uClass = org.nmdp.hmlfhirconvertermodels.dto.Sequence.class;
