...
public class GlString extends SwaggerConverter<GlString, org.nmdp.hmlfhirconvertermodels.dto.GlString> implements Serializable, ICascadable {

    private static Class<GlString> tClass = GlString.class;
    private static Class<org.nmdp.hmlfhirconvertermodels.dto.GlString> uClass = org.nmdp.hmlfhirconvertermodels.dto.GlString.class;
